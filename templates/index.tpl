...
<html lang="en-GB" dir="ltr">
	<head>
		...
		<link rel="stylesheet" type="text/css" href="pcss/index.css?14-0-6-2-637127272813517772" media="screen,print" />
		...
		<link rel="icon" href="favicon.ico?14-0-6-2-637127272813507800" type="image/vnd.microsoft.icon" />
	</head>
	<body>
